 ...
 * @Author jilanyang
 * @Package cn.spark.sql.c01_source
 * @Class D06_DataSetDemo
 * @Date 2021/6/4 0004 11:01
 */
object D06_DataSetDemo {
  def main(args: Array[String]): Unit = {
    System.setProperty("hadoop.home.dir", "D:\\software\\devsoft\\hadoopBin")

    val sparkSession: SparkSession = SparkSession.builder()
      .master("local[*]")
      .appName("D06_DataSetDemo")
      .getOrCreate()
    ...
    val inputDs: Dataset[Person] = Seq(
      Person("张三", 23),
      Person("李四", 33),
      Person("王五", 77),
      Person("赵六", 55)
    ...
    // rdd -> DataSet
    val inputDs2: Dataset[Person] = sparkSession.sparkContext
      .makeRDD(List(("张三", 23), ("李四", 33), ("王五", 77), ("赵六", 55)))
