...
```shell
bin/flink run -Dexecution.runtime-mode=AUTOMATIC -m yarn-cluster -yjm 1024 -ytm 1024 -c cn.jly.bigdata.flink.datastream.c01_quickstart.D02_StreamWordCount -p 2 ./original-module10-flink-java-1.0.0.jar --host linux01 --port 9999
```

-Dexecution.runtime-mode=AUTOMATIC 指定运行模式（代码中也可以指定）
