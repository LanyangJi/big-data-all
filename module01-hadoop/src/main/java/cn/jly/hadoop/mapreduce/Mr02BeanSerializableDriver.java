 ...
 */
public class Mr02BeanSerializableDriver extends BaseConfig {
    public static void main(String[] args) throws Exception {
        ...
        job.setJarByClass(Mr02BeanSerializableDriver.class);
        ...
        FileOutputFormat.setOutputPath(job, new Path("E:\\flowcount\\output"));
