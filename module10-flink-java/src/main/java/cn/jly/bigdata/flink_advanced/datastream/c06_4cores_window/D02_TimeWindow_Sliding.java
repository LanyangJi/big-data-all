...
/**
 * 基于时间的滑动窗口_ 基于处理时间（processing time）
 * <p>
 * 需求：
 * 每5秒钟统计一次，最近10秒钟内，经过各个路口的骑车数量
 *
 * @author jilanyang
 * @date 2021/7/29 14:00
 * @package cn.jly.bigdata.flink_advanced.datastream.c06_4cores_window
 * @class D01_TimeWindow_Sliding
 */
public class D02_TimeWindow_Sliding {
    public static void main(String[] args) throws Exception {
        ...
        env.execute("D02_TimeWindow_Sliding");
    }
}
