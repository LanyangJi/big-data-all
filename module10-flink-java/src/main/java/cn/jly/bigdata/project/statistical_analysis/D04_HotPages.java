...
public class D04_HotPages {
    ...
    public static void main(String[] args) {
        ...
        SingleOutputStreamOperator<ApacheLogEvent> logEventDS = lineDS.flatMap(
                        new FlatMapFunction<String, ApacheLogEvent>() {
                ...
                .assignTimestampsAndWatermarks(
                        ...
                        WatermarkStrategy.<ApacheLogEvent>forBoundedOutOfOrderness(Duration.ofMinutes(10))
                                .withTimestampAssigner(
                                        new SerializableTimestampAssigner<ApacheLogEvent>() {
                                            @Override
        ...
        // 分组开窗聚合
        SingleOutputStreamOperator<PageViewCount> windowAggDS = logEventDS.filter(
                ...
                .keyBy(
                        new KeySelector<ApacheLogEvent, String>() {
                            @Override
        ...
        windowAggDS.keyBy(
                ...
                .process(
                        new KeyedProcessFunction<Long, PageViewCount, PageViewCount>() {
                            ...
                            @Override
                            public void processElement(PageViewCount pageViewCount, KeyedProcessFunction<Long, PageViewCount, PageViewCount>.Context ctx, Collector<PageViewCount> out) throws Exception {
                ...
                .map(
                        new MapFunction<PageViewCount, String>() {
                            ...
                            public String map(PageViewCount value) throws Exception {
                                ...
                                sb.append("窗口结束时间：")
                                        .append(dateFormat.format(value.getWindowEnd()))
                                        .append(",")
                                        .append("页面：")
                                        .append(value.getUrl())
                                        .append(",")
